...
class LibraryLibrarianAgent:
    ...
    def run(self, query: str, history: List[Dict[str, str]] = None) -> Dict[str, Any]:
        ...
        prompt = (
            ...
            "6. PERINGATAN KETAT: DILARANG KERAS mengubah atau meriset angka metrik (seperti Total Transaksi, Sedang Dipinjam, Denda, atau Buku Terpopuler) di Tool Output menjadi 0 hanya karena kueri menyebut kata 'bulan ini' atau 'terbaru'. Anda WAJIB menyajikan angka faktual dari Tool Output secara tepat dan utuh sebagaimana adanya.\n\n"
