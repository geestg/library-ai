...
# Ensure backend root is in sys.path for app.* imports
...
# =========================================
try:
    from app.api.routes.routes_search import router as search_router
    app.include_router(search_router)
except Exception as e:
    print(f"[WARN] Failed to load search_router: {e}")

try:
    from app.api.routes.routes_chat import router as chat_router
    app.include_router(chat_router)
except Exception as e:
    print(f"[WARN] Failed to load chat_router: {e}")

try:
    from app.api.routes.routes_chat_stream import router as stream_router
    app.include_router(stream_router)
except Exception as e:
    print(f"[WARN] Failed to load stream_router: {e}")

try:
    from app.api.routes.routes_session import router as session_router
    app.include_router(session_router)
except Exception as e:
    print(f"[WARN] Failed to load session_router: {e}")

try:
    from app.api.routes.routes_upload import router as upload_router
    app.include_router(upload_router)
except Exception as e:
    print(f"[WARN] Failed to load upload_router: {e}")

try:
    from app.api.routes.routes_debug import router as debug_router
    app.include_router(debug_router)
except Exception as e:
    print(f"[WARN] Failed to load debug_router: {e}")

try:
    from app.api.routes.research import router as backend_research_router
    app.include_router(backend_research_router)
except Exception as e:
    print(f"[WARN] Failed to load backend_research_router: {e}")

try:
    from app.api.routes.title_generator import router as title_generator_router
    app.include_router(title_generator_router)
except Exception as e:
    print(f"[WARN] Failed to load title_generator_router: {e}")

try:
    from app.api.routes.routes_document import router as backend_document_router
    app.include_router(backend_document_router)
except Exception as e:
    print(f"[WARN] Failed to load backend_document_router: {e}")

try:
    from app.api.routes.routes_vision import router as vision_router
    app.include_router(vision_router)
except Exception as e:
    print(f"[WARN] Failed to load vision_router: {e}")

try:
    from app.api.routes.routes_speech import router as speech_router
