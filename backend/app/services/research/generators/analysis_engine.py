...
from app.services.research.analysis.evidence_classifier import classify_all_evidences
from app.services.research.analysis.gap_validator import validate_and_synthesize_gaps
...
def run_analysis(context: ResearchContext) -> ResearchContext:
    ...
    try:
        from app.services.research.gap.gap_detector import extract_bab5_gaps
