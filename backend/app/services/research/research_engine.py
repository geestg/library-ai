...
from app.services.research.generators.research_gap_generator import generate_research_gap_report
from app.services.research.generators.corpus_novelty_generator import generate_corpus_novelty_check
from app.services.research.generators.method_comparison_generator import generate_method_comparison
...
def research_analysis(
    ...
    from app.services.research.search_engine import is_contextual_followup
    ...
    from app.orchestration.task_router import route_query
    ...
    if is_generating_ideas:
        from app.orchestration.completeness_checker import check_information_completeness
